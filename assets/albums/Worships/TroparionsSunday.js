export const TroparionsSunday = [
  ...
  },
  {
    ...
    text: [
      ...
      'Кандак',
      'Ты ўваскрэс з магілы, Усемагутны Спасіцелю, і пекла, убачыўшы цуд, жахну́лася, і мёртвыя паўсталі, а стварэнне, бачачы, радуецца з Табою, і Адам весяліцца, і свет, Спасіцелю мой, апява́е Цябе заўжды.',
    ],
  },
  {
    slug: 'tune-3',
  ...
  },
  {
    ...
    text: [
      ...
      'Кандак',
      'Ужо больш улада́нне смерці не зможа трымаць людзей, бо Хрыстос сышоў, разбура́ючы і знішча́ючы сілы яго. Звя́зваецца пекла, прарокі згодна радуюцца, гаворачы: прадста́ў Спасіцель тым, што ў веры, выходзьце, верныя, ва ўваскрасенне.',
    ],
  },
  {
    slug: 'tune-8',
    ...
    text: [
      'Трапар',
      'З вышыні сышоў Ты, Міласэрны, пахаванне Ты прыня́ў трохдзённае, каб нас вы́зваліць ад пакут, жыццё і ўваскрасенне наша, Госпадзі, слава Табе.',
      'Кандак',
