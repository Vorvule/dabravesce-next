...
import { calendarEaster } from '@/screens/calendar/model/calendar.easter';
import { calendarDates } from '@/screens/calendar/model/calendar.dates';
import { FEAST_SOURCES } from '@/screens/calendar/data/feast.sources';
import { Calendar, ImmovableEvent, MovableEvent } from '@/screens/calendar/types/calendar.types';
