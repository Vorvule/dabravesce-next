import { easterProvider } from '@/applets/calendar/logic/easter.provider';
import { calendarEaster } from '@/applets/calendar/model/calendar.easter';
import { calendarDates } from '@/applets/calendar/model/calendar.dates';
import { FEAST_SOURCES } from '@/applets/calendar/data/feast.sources';
import { Calendar, ImmovableEvent, MovableEvent } from '@/applets/calendar/types/calendar.types';
